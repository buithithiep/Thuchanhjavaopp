...
public class App41{
    public static void main(String[] args) {
        ...
        System.out.println("Nhạp vào chỉ số của phần tử cần lấy: ");
        int index = scanner.nextInt();
        if ((index < 0 || (index > (linkedList.size() - 1)))) {
            System.out.println("Chỉ số cần lấy phải lớn hơn 0 à nhỏ hơn " + (linkedList.size()-1));
        } else {
        ...
        System.out.println("\nPhần tử đầu tiên có trong danh sách là " + firstNode + " ; Phần tử cuối cùng trong dánh sách là " + lastNode);
    }
}
